        ...
        <div className="overflow-x-auto">
          <table className="min-w-full bg-base-100 bg-white border border-gray-200 rounded-lg shadow-md">
            <thead className="bg-gray-100">
              <tr>
                <th className="px-3 py-2 border w-5 bg-base-100">Sr.</th>
                ...
                <th className="px-3 py-2  border bg-base-100">Action</th>
              </tr>
            </thead>
              ...
              {Array?.isArray(displaySales) && displaySales?.length > 0 ? (
                displaySales?.map((sales, index) => (
                  <tr key={sales?._id} className="">
                    ...
                    <td className="px-3 py-2 border">{sales?.customerName}</td>
                    <td className="px-3 py-2 border">
                      {sales.products?.product?.name || "No Product"}
                    </td>
                    <td className="px-3 py-2 border">{sales?.totalAmount}</td>
